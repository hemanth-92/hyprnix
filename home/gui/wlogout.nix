  ...
  programs.wlogout = {
    ...
    style = ''
      * {
      ...
      window {
        background-color: rgba(24, 24, 37, 0.1); /* Base Background: Catppuccin Mocha Base */
      }
      button {
        color: #cdd6f4; /* Text: Catppuccin Mocha Text */
        font-size: 20px;
      ...
      button:active,
      button:hover {
        color: #f5c2e7; /* Pink: Catppuccin Mocha Pink */
